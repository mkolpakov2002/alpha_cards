...
class HardwareListViewModel : ViewModel() {
    ...
    private val _items = MutableLiveData<List<Hardware>>()
    val items: LiveData<List<Hardware>> = _items

    private val _selectedItems = mutableSetOf<Hardware>()
    ...
    fun onItemClick(item: Hardware) {
        // Handle item click event
        // Navigate to the item details fragment
    }

    fun onItemLongClick(item: Hardware) {
