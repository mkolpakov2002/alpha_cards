...
class LabListFragment : Fragment() {
    ...
    private val viewModel: LabListViewModel by viewModels()
    ...
    private fun onItemClick(labItem: LabItem) {
        val action = LabListFragmentDirections.actionLabListFragmentToRoomListFragment(labItem.id)
        Navigation.findNavController(requireView()).navigate(action)
    }

    private fun onItemLongClick(labItem: LabItem) {
...
class ItemAdapter(
    ...
    private val onItemLongClick: (LabItem) -> Unit
) : ListAdapter<LabItem, ItemAdapter.ViewHolder>(ItemDiffCallback<LabItem>()) {

    private val expandedPositions = mutableSetOf<Int>()

    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        val view = LayoutInflater.from(parent.context).inflate(R.layout.item_card_lab, parent, false)
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        fun bind(item: LabItem, position: Int) {
